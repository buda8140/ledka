...
struct ModesView: View {
    ...
    let presets = [
        ModePreset(name: "Smooth Rainbow", value: 0x25, color: .orange),
        ModePreset(name: "7 Color Pulse", value: 0x26, color: .purple),
                    ...
                    VStack(spacing: 25) {
                        ...
                        GlassCard {
                            VStack(spacing: 25) {
                                ...
                                VStack(spacing: 20) {
                                    ControlSlider(title: "Brightness", value: $brightness, icon: "sun.max.fill") { val in
                                        btManager.setBrightness(Int(val))
                                    }
                                    
                                    ControlSlider(title: "Speed", value: $speed, icon: "bolt.fill") { val in
